...
- route-graphics expose interface at behaviors level, keep the behavior, texture and emitter. Maybe decide it better grouped.
...
- Exposure of fields different for different presets