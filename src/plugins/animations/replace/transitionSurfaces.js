...
import { invalidateSnapshotRenderGroup } from "../../../renderer/pixi/snapshotRenderGroupAdapter.js";
import {
  createShaderEffect,
  destroyShaderEffect,
...
const generateLocalSnapshotTexture = ({ app, displayObject, frame }) => {
  ...
  try {
    ...
    // it here; createSnapshotSubject applies the saved pivot to the sprite.
